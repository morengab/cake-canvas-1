...
function ul2finder()
{
	...
	for(i=0;i<lis.length;i++)
	{
		...
		//set values
		newImg.src = lis[i].firstChild.nodeValue;
		newImg.setAttribute('margin', '0px');
		newImg.setAttribute('padding', '0px');
		newImg.setAttribute('border', '0px');
		
		//append as child of a tag
		newa.appendChild(newImg);
		
		//replace text/first child with <a> tag and embedded <img> tag
